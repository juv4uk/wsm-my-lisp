**Документація**: поточна архітектура/плани/контракти — [`docs/CURRENT.md`](docs/CURRENT.md). Усе під `docs/archive/` — non-normative історія, ніколи не джерело вимог (`wsm-my-lisp#19`, ecosystem-wide `DOC-AUTHORITY-ARCHIVE`).
